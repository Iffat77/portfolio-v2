  ...
  return (
    <div className="h-screen w-screen bg-amber-50 dark:bg-[#04141E] dark:text-gray-300 overflow-auto">
      <div className="pt-28 px-6 w-full h-full dark:text-white grid grid-cols-1 grid-rows-5 lg:grid-cols-2 lg:grid-rows-3 md:gap-4 ">
        ...
        <h2 className="font-font-work justify-self-start place-self-center row-span-1 lg:col-span-2 lg:row-span-1 text-4xl md:text-6xl lg:pl-8 pt-3 dark:text-white">
          Apex Stat Tracker
        </h2>
        ...
        <div className="w-full max-w-lg text-xl md:text-2xl lg:pl-8  lg:justify-self-start">
          <a
            ...
            className="relative inline-flex items-center justify-center px-6 py-3 overflow-hidden font-bold text-white rounded-md shadow-2xl group animate-pulse bg-gray-500"
          >
