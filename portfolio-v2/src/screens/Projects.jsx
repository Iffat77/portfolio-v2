  ...
  return (
    <div className="snap-y snap-mandatory scroll-pb-8 md:scroll-pb-10 h-screen w-screen mx:auto overflow-x-hidden dark:bg-[#04141E] dark:text-gray-300 ">
      <div className="pt-28 px-6 snap-end h-screen dark:text-white grid grid-cols-1 grid-rows-7 lg:grid-cols-2 lg:grid-rows-3 gap-2 md:gap-4 ">
        <section className="bg-lesscarbon row-span-4 lg:row-start-2 lg:row-span-2 h-full w-full rounded-md bg-no-repeat bg-cover bg-center shadow-black shadow-md"></section>
        ...
        <div className="max-w-lg row-span-1 lg:row-start-2 ">
          <p className="w-auto max-w-lg text-lg md:text-xl lg:pl-8 lg:py-6 leading-10">
            Less Carbon is a platform and community where users can express
            themselves and connect with like-minded individuals. It provides a
            space for people to share their voices and engage with others by
            commenting on articles and even contributing their own written
            pieces.
          </p>
        </div>
        <div className="w-full flex justify-start gap-8 row-span-1 text-xl  pb-2 md:text-2xl lg:row-start-3 lg:pl-8  md:place-self-center lg:place-self-center ">
          ...
          <div className=" max-w-lg text-xl md:text-2xl ">
            <a
              ...
              className="relative inline-flex items-center justify-center px-5 py-2 md:px-6 md:py-3 overflow-hidden font-bold text-white rounded-md group animate-pulse bg-gray-400 hover:bg-gray-700 shadow-gray-500 shadow-md dark:shadow-none"
            >
        ...
        <div className="w-full flex justify-start gap-8 row-span-1 text-xl  pb-2 md:text-2xl lg:row-start-3 lg:pl-8  md:place-self-center lg:place-self-center ">
          ...
          <div className=" max-w-lg text-xl md:text-2xl ">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="relative inline-flex items-center justify-center px-5 py-2 md:px-6 md:py-3 overflow-hidden font-bold text-white rounded-md group animate-pulse bg-amber-600  hover:bg-orange-700 shadow-gray-500 shadow-md dark:shadow-none"
            >
              <span className="relative "> Live Site</span>
            </a>
          </div>
        ...
        <div className="w-full flex justify-start gap-8 row-span-1 text-xl  pb-2 md:text-2xl lg:row-start-3 lg:pl-8  md:place-self-center lg:place-self-center ">
          ...
          <div className=" max-w-lg text-xl md:text-2xl ">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="relative inline-flex items-center justify-center px-5 py-2 md:px-6 md:py-3 overflow-hidden font-bold text-white rounded-md group animate-puls bg-sky-600 hover:bg-blue-700 shadow-gray-500 shadow-md dark:shadow-none"
            >
              <span className="relative "> Live Site</span>
            </a>
          </div>
